"""
By the way, none of this is written by AI :)
I wrote all this while taking a tutorial on DeepLearning.AI
...
#=======================================================
# Prompting PPrinciple 1: Write clear and specific instructions
#=======================================================
...
def prompt_with_specific_steps():
    text = f"""
...
def work_your_own_solution_prompt():
    return f"""
...
if __name__ == "__main__":
    response = get_completions(json_prompt())
    print(response)